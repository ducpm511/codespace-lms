...
const ROLE_PERMISSIONS = {
  ...
  instructor: [
    PERMISSIONS.COURSE_READ, PERMISSIONS.COURSE_CREATE, PERMISSIONS.COURSE_UPDATE,
    // COURSE_DELETE: GV phải tự dọn được khóa mình lỡ tạo, không phải nhờ admin. Rào chắn nằm ở
    // service — khóa đang gán cho lớp thì từ chối xóa (409), nên chỉ xóa được khóa chưa dùng.
    PERMISSIONS.COURSE_PUBLISH, PERMISSIONS.COURSE_DELETE,
